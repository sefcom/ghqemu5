...
bool visit_type_q_obj_set_password_arg_members(Visitor *v, q_obj_set_password_arg *obj, Error **errp)
{
    ...
    if (visit_optional(v, "connected", &obj->has_connected)) {
        if (!visit_type_str(v, "connected", &obj->connected, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_q_obj_expire_password_arg_members(Visitor *v, q_obj_expire_password_arg *obj, Error **errp)
{
    if (!visit_type_str(v, "protocol", &obj->protocol, errp)) {
        return false;
    }
